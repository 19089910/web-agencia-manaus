  ...
  return (
    <header
      className={cn(
        ...
        isScrolled ? 'bg-agency-dark shadow-lg py-2' : 'bg-transparent py-3 sm:py-4'
      )}
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        <a href="#" className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
        ...
        <nav className="hidden md:flex items-center space-x-4 lg:space-x-6">
          ...
          <Button variant="outline" className="border-agency-red text-agency-red hover:bg-agency-red hover:text-white">
            Solicitar Orçamento
          </Button>
        </nav>
      ...
      >
        <div className="container mx-auto px-4 py-6 flex flex-col space-y-6">
          ...
          <Button variant="outline" className="border-agency-red text-agency-red hover:bg-agency-red hover:text-white w-full py-6 mt-4" onClick={closeMenu}>
            Solicitar Orçamento
          </Button>
        </div>
      </div>

...
const Footer: React.FC = () => {
  ...
  const footerNavItems = navigationItems.filter(item => 
    !['#inicio'].includes(item.href) // Remove "Início" do footer se desejado
  );
      ...
      <div className="container mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Soluções web personalizadas que geram resultados reais para o seu negócio. Aumente suas vendas e visibilidade online.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerNavItems.map((item) => (
                <li key={item.href}>
                  <a href={item.href} className="text-gray-400 hover:text-agency-red transition-colors">
                    {item.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {saasLinks.map((link, index) => (
                <li key={index}>
                  <a href={link.href} className="text-gray-400 hover:text-agency-red transition-colors">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <a href="mailto:contato@webagency.com" className="text-gray-400 hover:text-agency-red">contato@webagency.com</a>
              </li>
              <li className="flex items-start">
                <div className="text-agency-red mr-3 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <a href="tel:+551199998888" className="text-gray-400 hover:text-agency-red">(11) 9999-8888</a>
              </li>
              <li className="flex items-start">
                <div className="text-agency-red mr-3 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="border-t border-agency-dark-light pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-500 mb-4 md:mb-0">
            © {currentYear} WebAgency. Todos os direitos reservados.
          </div>
          <div className="flex space-x-6">
            <a href="#" className="text-gray-500 hover:text-agency-red transition-colors text-sm">Termos de Uso</a>
            <a href="#" className="text-gray-500 hover:text-agency-red transition-colors text-sm">Política de Privacidade</a>
            <a href="#" className="text-gray-500 hover:text-agency-red transition-colors text-sm">Cookies</a>
          </div>
        </div>
      </div>
    </footer>

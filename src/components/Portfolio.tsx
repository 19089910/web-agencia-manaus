    ...
    <section id="portfolio" className="py-16 sm:py-20 bg-agency-dark-lighter">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4 red-line">
            Nosso Portfólio
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base">
            Confira alguns dos projetos de landing pages e websites que
            desenvolvemos para nossos clientes. Cada projeto é único e
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {portfolioItems.map((item) => (
            <Card
              key={item.id}
              className="overflow-hidden bg-agency-dark border border-agency-dark-light hover:border-agency-red/50 transition-all duration-300 group"
            >
              <div className="relative h-48 sm:h-60 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                  <div className="p-4 w-full">
                    <span className="text-xs font-medium text-agency-red uppercase tracking-wider">
                      {item.category}
                    </span>
